    ...
    <>
      ...
      <Row class="gjs-grid-row">
            <Col class="gjs-grid-column">
                ...
                <p id="acfc1" class="normal-text">Próximamente, podrás recibir notificaciones anticipadas para que te prepares de la mejor manera y celebres el día especial de esa persona querida.<br />
                </p>
            </Col>
        </Row>
    </>
